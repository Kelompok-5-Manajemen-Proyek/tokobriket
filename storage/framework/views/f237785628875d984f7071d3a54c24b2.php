    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="home"><?php echo e(auth()->user()->email ?? 'Selamat Datang, Tamu'); ?></a>
                </li>
                <?php if(auth()->user()): ?>
...
<?php /**PATH C:\xampp\htdocs\tokobriket\resources\views/navbar.blade.php ENDPATH**/ ?>