    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <?php endif; ?>
          <li><a class="getstarted scrollto" href="#"><?php echo e(auth()->user()->email); ?></a></li>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
            Arang Briket Wringinsongo adalah produk arang atau briket arang yang dikenal dengan merek Wringinsongo. Briket arang ini adalah hasil olahan dari bahan bakar biomassa, seperti serbuk kayu, serbuk tempurung kelapa,
            atau bahan organik lainnya, yang kemudian diproses menjadi briket dengan tujuan untuk digunakan sebagai bahan bakar alternatif.
            </p>
            <ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <h3>Briket 1</h3>
              <h4><sup>Rp</sup>50.000<span>1 Lusin</span></h4>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              <img src="assets/img/produk/briket.png" class="img-fluid animated" alt="Arang Briket">
              <h3>Briket 2</h3>
              <h4><sup>Rp.</sup>30.000<span>1 Lusin</span></h4>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <img src="assets/img/produk/briket.png" class="img-fluid animated" alt="Arang Briket">
              <h3>Briket 3</h3>
              <h4><sup>Rp.</sup>35.000<span>1 Lusin</span></h4>
              <a href="#" class="buy-btn">Buy</a>
            </div>
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\tokobriket\resources\views/tokobriket.blade.php ENDPATH**/ ?>